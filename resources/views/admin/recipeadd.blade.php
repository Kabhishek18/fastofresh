            ...
            <div class="content-header row">
                <div class="content-header-left col-md-9 col-12 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h2 class="content-header-title float-left mb-0">Recipe</h2>
                            <div class="breadcrumb-wrapper col-12">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="{{url('laravel-admin/dashboard')}}">Home</a>
                                    </li>
                                    <li class="breadcrumb-item"><a href="{{url('laravel-admin/recipe')}}">Recipe</a>
                                    </li>
                        ...
                        <div class="col-md-12 col-sm-12">
                            <div class="card">
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body">
                                        <form class="form-horizontal" method="post" action="{{url('laravel-admin/recipe/insert')}}" enctype="multipart/form-data"> 
                                            @csrf
                                            ...
                                            <input type="hidden" name="id" value="{{$datalist->id}}">
                                             ...
                                             <div class="row">
                                               ...
                                               <div class="col-sm-12">
                                                   ...
                                                   <textarea name="ingredient" id="ingredient" contenteditable="true">
                                                    <?=(!empty($datalist->ingredient)?$datalist->ingredient:'')?>
                                                   </textarea>
                                                    </div>
                                                </div>
                                                 ...
                                                 <div class="col-sm-8">
                                                    <div class="form-group">
                                                        <div class="controls">
                                                            <label>Recipe Image<span class="text-danger">*</span></label>
                                                ...
                                                <img src="{{url('')}}/recipes/{{$datalist->image}}" width="100px">
                                                @endif
                                                </div>
                                                <div class="col-sm-12">
                                                    <div class="form-group">
                                                        <div class="controls">
                                                            <label>Recipe description<span class="text-danger">*</span></label>
